...
async function SocialActionMb({lang}) {
    ...
    return (
        <div className='md:hidden popUpAction flex flex-col gap-[0.5rem] bg-transparent fixed z-50 right-0 top-[58%] -translate-y-[30%] px-[0.5rem] py-[1.5rem] rounded-bl-[1.97rem]'>
            <Link href={`tel:${dataPartner?.socialAction?.phone}`} className='transition-all hover:scale-95'>
              <Image className='w-[12.5632rem] h-[12.50213rem] object-contain' src={phone} width={'100%'} height={'100%'} alt='phone' />
            </Link>
            <Link href={`${dataPartner?.socialAction?.zalo}`} target='_blank' className='transition-all hover:scale-95'>
              <Image className='w-[12.5632rem] h-[12.50213rem] object-contain' src={zalo} width={'100%'} height={'100%'} alt='zalo' />
            </Link>
            <Link href={`${dataPartner?.socialAction?.facebook}`} target='_blank' className='transition-all hover:scale-95'>
              <Image className='w-[12.5632rem] h-[12.50213rem] object-contain' src={fb} width={'100%'} height={'100%'} alt='facebook' />
            </Link>
            <Link href={`${dataPartner?.socialAction?.linkedin}`} target='_blank' className='transition-all hover:scale-95'>
              <Image className='w-[12.5632rem] h-[12.50213rem] object-contain' src={linked} width={'100%'} height={'100%'} alt='facebook' />
            </Link>
        </div>
  )
}
